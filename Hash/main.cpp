...
int main(){
	...
	new_player = database.qbAssist("Tre", "KrjnPwn", 345);

	database.insert(new_player);


	new_player = database.qbAssist("Tre", "OPoooown", 345);

	database.insert(new_player);

	new_player = database.qbAssist("Tre", "bLooooPwn", 345);

	database.insert(new_player);

	new_player = database.qbAssist("Tre", "KrppppPwn", 345);

	database.insert(new_player);

	new_player = database.qbAssist("Tre", "OPooiiiioown", 345);

	database.insert(new_player);

	new_player = database.qbAssist("Tre", "bLooooooooooPwn", 345);

	database.insert(new_player);

	new_player = database.qbAssist("Tre", "KrpppooooooopPwn", 345);
